...
/*                            Список команд                         */
 ...
 { "rotate",     "r",  "#ROTATE (R) - Безотрывное вращение вокруг текущей целевой точки", 
                       " ROTATE  <Имя>\n",
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
         ...
         if(stop_flag || this->kernel->stop)  break ;               /* Если цель достигнута или внешнее прерывание поиска */
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
         ...
         if(stop_flag || this->kernel->stop)                        /* Если цель достигнута или внешнее прерывание поиска - */
